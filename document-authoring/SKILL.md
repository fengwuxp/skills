...
把已提供或已核验的材料组织成面向明确读者、可评审、可修订、可交付的正式文档。负责文档表达与交付质量，不替代产品、工程、法律、合规或领域专家作事实判断。
...
- PRD、产品方案、产品验收：由 `产品架构专家` 主责，本技能只处理结构、表达、引用和载体。
- 系分、ADR、技术方案、代码 Review、生产变更：由 `资深架构师` 主责，本技能只处理结构、表达、引用和载体。
