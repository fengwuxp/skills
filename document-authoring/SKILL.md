...
description: Use when 用户要把分散材料或稳定领域结论整理、审校为正式报告、制度、手册、研究说明、总结、培训材料、通俗解释页或视觉预习页，或整理小说项目档案；小说正文、PRD/系分设计、古籍训诂和简短解释不触发。
---
...
7. 治理小说创作项目时，文档区分作者侧、编辑侧和读者侧，只管理权威、职责、状态、剧透等级、引用和载体；故事语义、人物弧光和正文仍由 `novelist` 与作者负责。
