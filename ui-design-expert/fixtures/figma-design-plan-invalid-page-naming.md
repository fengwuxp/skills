# Invalid Figma Design Plan: Page Naming

## Design Contract

```design-contract
project_id: invalid-page-name
client_scope: web-pc
...
route: /
display_name: Home
figma_name: Web PC / Home / default / 1440 / Draft
purpose: explain-positioning
source_node: https://www.figma.com/design/reference/file?node-id=1-2
states: default
state_exclusions: loading, empty, error, success, permission, return, close
state_notes: default is covered
