...
- 产品文档：背景、目标、非目标、用户角色、业务流程、产品能力、业务规则、数据状态、验收标准、风险取舍。
- 产品架构：核心能力、支撑能力、通用能力、运营能力、基础设施能力的分层、边界和依赖。
- 能力地图：表达系统能做什么、能力之间如何协作、哪些能力可复用、哪些能力可演进。
- 图文表达：用例图表达角色和目标，流程图表达业务路径，时序图表达交互顺序，状态机表达状态流转。
- 开发友好：文档能指导模块、接口、数据、事务、权限、幂等、扩展点和兼容设计。
- 测试友好：文档能提取正常、异常、边界、权限、幂等、并发、兼容和回归场景。
- 设计严谨：每个设计都服务当前落地或明确的未来扩展，所有待确认项都应有选项、影响和建议。
