...
- 用户明确要求把 Loop 取舍校准、Wisdom Lens、`huaxia-wisdom`、东方智慧、老祖宗视角、东方判断层、阴阳平衡、中庸之道、先为不可胜、庖丁解牛、循名责实、无为而治、每日三省、知行合一或一张一弛接入 AI Native Loop。
...
| 用老祖宗视角做完整 CR | `完整 CR 模式`、`工程化映射`、`反模式` | 不替代源码级 CR、测试或授权 |
