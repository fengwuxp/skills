...
| 升级 SDD / Superpowers 6.0 / Harness 版本 | `2. OpenSpec / Superpowers / Harness`、`2A. AI Native Harness Contract v2`，再读 `superpowers-skill-library.md` 和 `code-delivery-closed-loop.md` | 不把 v6 脚本或 `.superpowers/sdd/` 写成默认安装态 |
...
## 2A. AI Native Harness Contract v2

`AI Native Harness Contract v2` 是本仓库内部执行契约版本，不是外部 Harness、插件、脚本或 `.superpowers/sdd/` 安装版本。它在原有 Harness v1（owner、顺序、写入范围、验证命令、停止条件和交接）之上，吸收 Superpowers v6 SDD 的可迁移纪律：
...
- 不复制或运行 Superpowers v6 的 `task-brief`、`review-package`、`sdd-workspace`、visual companion server、hooks、插件 manifest 或安装脚本。
