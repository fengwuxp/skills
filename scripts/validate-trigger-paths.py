...
check(
    ...
    (
        has_all(
            ...
            [
                ...
                "本技能负责端到端准入、owner、顺序、停止条件、授权策略和交接结论",
                "需求分析协同门禁模式",
                "问题核心诊断模式",
                "产品 / 系统 DNA 门禁模式",
                "GSD + Goal / 授权策略模式",
                "Spec 模板模式 / SDD 生产代码模式 / AI 代码交付闭环模式",
                "Skill 类型路由模式 / 知识回流模式",
                "Agent Loop Engineering / Loop-GSD-CAD 协同模式",
    ...
    or has_all(
        ...
        [
            ...
            "标准服务交付",
            "顶层原则先行",
            "当用户要求“提炼原则”“处事方式”“方法论沉淀”或外部文章吸收时",
            "用户要求提炼顶层原则、处事方式、方法论纲要、跨 Skill 共同约束",
            "开发标准门禁模式",
            "开发标准门禁包",
            ...
            "Gemini CLI / AgentRC / Understand Anything 安装、调用或工具辅助代码阅读可以从本技能进入",
            ...
            "不把 Gemini CLI / AgentRC / Understand Anything 作为默认入口",
...
check(
    ...
    all(
        ...
        for term in [
            "AI Native 产研协同研发流程编排与准入门禁",
            "把产品专家、架构师、AI Agent、GSD/CAD/Goal/Loop",
            "可交接、可验证、可停止",
    ...
    and has_all(
        ...
        [
            "编排产品专家、架构师、AI Agent、GSD/CAD/Goal/Loop、验证发布和授权策略",
            "按当前材料选择最小流程",
