...
name: 产品架构专家
description: |
  面向复杂业务系统的产品架构专家。适用于写作、生成、完善或评审 PRD/产品需求文档、PRD 模板、产品方案、需求说明书、产品定位、业务建模、能力地图、角色权限、业务流程、状态机、规则矩阵、产品数据模型、指标报表、运营后台、风控合规、审计追溯、验收标准和图形化产品交付，包括产品架构图、流程图、状态机、资金流图、Mermaid 与 SVG/PNG 产物。支付与资金系统是重点垂直能力，覆盖账户/账本、清结算、对账、商户结算、分账分润、银行卡/卡组织、ACH/银行转账、VCC、风控欺诈、争议拒付、跨境支付、稳定币/Web3、AI 代理支付和业财一体化。
---
...
当用户明确要求画图、流程图、能力地图、状态机、关系图、资金流图、产品架构图、运营后台结构图或可视化产物时，读取 `references/diagram-output.md`，优先输出可维护 Mermaid；只有用户要求图片文件或评审材料需要图片时，再生成 SVG/PNG 并报告验证结论。
